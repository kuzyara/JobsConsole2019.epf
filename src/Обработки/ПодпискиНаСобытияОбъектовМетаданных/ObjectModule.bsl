...
//ПриКопировании
	...
	СтруктураТиповМета = Новый Соответствие;
	...
	СтруктураТиповМета.Вставить("ПланСчетов", Метаданные.ПланыСчетов.Количество());
	СтруктураТиповМета.Вставить("ПланВидовРасчета", Метаданные.ПланыВидовРасчета.Количество());
	...
	СтруктураТиповМета.Вставить("РегистрБухгалтерии", Метаданные.РегистрыБухгалтерии.Количество());
	СтруктураТиповМета.Вставить("РегистрРасчета", Метаданные.РегистрыРасчета.Количество());
